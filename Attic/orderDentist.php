...
<div id="header">
  <div id="menu" class="container">
	...
	<div id="page" class="container">
		<div id="content">
	  		<div class="title">
<form action="processDentist.php" method="post"
        	...
        	<td colspan="2">
            	<li>
        			<div align="center">
          				...
          				<input class="mainForm" onclick="collapseElement('page_1'); expandElement('page_2');" type="button" value="Continue" /> 
        			</div>
    			</li>
       		</td>
       	</tr>
    	...
    	<tr>
        	<td colspan="2"><li>   
        		<div align="center">
          			...
          			<input class="mainForm" onclick="collapseElement('page_2'); expandElement('page_3');" type="button" value="Continue" /> 
        		</div>
   				</li>
          	</td>
       	</tr>
...
<ul id="page_3">
	<table width="100%">
		...
		<tr>
        	<td colspan="4">
    			<li>
                	<input class="mainForm" onclick="collapseElement('page_3'); expandElement('page_2');" type="button" value="Back" /> 
