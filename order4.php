...
<div id="page" class="container">
	<div id="content">
	  <div class="title">
		...
		<form action="order5.php" method="post" enctype="multipart/form-data" name="test" target="_self">
          ...
          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span>quantity</div></td></tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "integer", {validateOn:["blur", "change"], isRequired:false, useCharacterMasking:true});
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "integer", {isRequired:false, useCharacterMasking:true, validateOn:["blur", "change"]});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3");
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "integer", {validateOn:["blur", "change"], useCharacterMasking:true, isRequired:false});
